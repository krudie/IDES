...
public class SubElement extends SubElementContainer implements Cloneable{
    ...
    private void initialize(){
        initialized = true;
        attributeList = new Hashtable<String, String>(DEFAULT_NUM_ATTRIBUTES);
    }
    ...
    /**
     * returns the values of all attributes in this subelement,
    ...
    /**
     * returns the names of all attributes in this subelement,
