...
public class EditActions
{
	public static class RenameAction extends AbstractAction
	{
		...
		protected class UndoableRename extends AbstractUndoableEdit
		{
			...
			/**
			 * Returns the name that should be displayed besides the Undo/Redo
			 * menu items, so the user knows which action will be undone/redone.
			 */
			@Override
		...
		public void actionPerformed(ActionEvent e)
		{
			...
			{
				newName = (String)JOptionPane.showInputDialog(Hub
						.getMainWindow(),
						labels,
						Hub.string("renameModelTitle"),
