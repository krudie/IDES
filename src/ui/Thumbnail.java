...
public class Thumbnail extends JPanel
{
	...
	protected Action closeButtonListener = new AbstractAction()
	{
		...
		{
			Thumbnail parent = (Thumbnail)((JButton)event.getSource())
					.getParent();
	...
	{
		super(layout);
		closeButton = new JButton(MetalIconFactory
				.getInternalFrameCloseIcon(DEFAULT_ICON_SIZE));
	...
	{
		closeButton.setBounds(this.getWidth() - cbWidth - 1,
				0,
				cbWidth,
				cbHeight);
