...
public class GlobalEventList extends JList
{
	...
	private static class EventRecordRenderer extends JLabel implements
			ListCellRenderer
	{
				...
				int index, boolean isSelected, boolean cellHasFocus)
		{
			...
			{
				setText(((EventRecord)value).event.getSymbol() + " ["
						+ ((EventRecord)value).model.getName() + "]");
			...
			if (isSelected)
			{
				setBackground(darker ? SystemColor.textHighlight.darker()
