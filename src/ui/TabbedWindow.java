...
public interface TabbedWindow extends UserInterface
{
	...
	/**
	 * Gets the name of the active tab in the main area. Returns the empty
	 * string if no tab is active.
	 * 
	...
	/**
	 * Gets the name of the active tab in the right area. Returns the empty
	 * string if no tab is active.
	 * 
	 * @return the name of the active tab
	 */
	...
	/**
	 * Gets the name of the active tab in the left area. Returns the empty
	 * string if no tab is active.
	 * 
	 * @return the name of the active tab
	 */
