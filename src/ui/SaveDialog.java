...
/**
 * A dialog box which lists unsaved DES models and lets the
 * user choose which ones to save.
 * 
...
public class SaveDialog extends EscapeDialog {
	...
	/**
	 * Returns a list of the DES models which need to be saved.
	 * If the user cancelled the dialog, returns <code>null</code>.
	 * @return if the dialog was not cancelled, a list of DES models
	 * which need to be saved; if the dialog was cancelled, <code>null</code>
	 */
