...
public class SaveDialog extends EscapeDialog
{
	 ...
	 * 
	 * @param modelsToSelect
	 *            which models the user has to choose from
	 ...
	 * 
	 * @return if the dialog was not cancelled, a list of DES models which need
	 *         to be saved; if the dialog was cancelled, <code>null</code>
	 */
