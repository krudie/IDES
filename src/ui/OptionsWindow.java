...
/**
 * This is the window of the Options dialog box.
 * It lets the user select from a list of
 ...
 * an {@link pluggable.ui.OptionsPane} as an argument. The set of controls
 * for the module or plugin have to appear in the {@link javax.swing.JPanel}
 * that is returned by the {@link pluggable.ui.OptionsPane#getPane()} method.
...
public class OptionsWindow extends EscapeDialog {
	...
	/**
	 * The registry which maps a section title to the corresponding {@link pluggable.ui.OptionsPane}.
	 */
	...
	/**
	 * Creates and displays the Options dialog, where the last selected
	 * section is pre-selected.
	...
	/**
	 * Creates and displays the Options dialog, where the specified
	 * section is pre-selected.
	...
	public OptionsWindow(String openTitle)
	{
		...
		JSplitPane stuffPane=new JSplitPane(JSplitPane.HORIZONTAL_SPLIT,
				new JScrollPane(sectionList),new JScrollPane(optionsHolder));
	 ...
	 * <p>Called when the user presses the <code>Escape</code> key to close
	 * the Options dialog. Also called by the Cancel button and when the
	...
	/**
	 * Registers a new section of option controls. Do not call directly.
	 * Use {@link main.Hub#registerOptionsPane(OptionsPane)} to register option panes.
	 * @param pane the {@link pluggable.ui.OptionsPane} which has to be added.
	 * @see main.Hub#registerOptionsPane(OptionsPane)
	 */
