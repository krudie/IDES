...
public class ResourceManager{
    ...
    public final static String FILE_NEW_PROJECT = "file_new_project",
                               ...
                               OPERATIONS_CONTROLLABLE = "operations.controllable";
     ...
     */
    private final static String[] resourcesWithImages = {FILE_NEW_PROJECT, FILE_OPEN_PROJECT, FILE_SAVE_PROJECT, FILE_NEW_AUTOMATON, FILE_OPEN_AUTOMATON, FILE_SAVE_AUTOMATON, EDIT_COPY, EDIT_PASTE,
            EDIT_DELETE, GRAPHIC_ZOOM, GRAPHIC_CREATE, GRAPHIC_MODIFY, GRAPHIC_PRINTAREA, GRAPHIC_GRAB, LOGO, GRAPHIC_ALLEDGES, GRAPHIC_ALLLABELS};
     ...
     */
    public final static int GRID_CURSOR = 0, ERROR_CURSOR = 1, CROSS_CURSOR = 2, UPDOWN_CURSOR = 3, LEFTRIGHT_CURSOR = 4, DIAGONAL_CURSOR = 5, WAIT_CURSOR = 6, ARROW_CURSOR = 7, ZOOM_CURSOR = 8,
            GRAB_CURSOR = 9, CREATE_CURSOR = 10, MODIFY_CURSOR = 11;

    /**
     * System cursors for preloading. Their indexes here correspond to indexes
     * in the cursors[] array, and the cursor index labels.
     * 
     * TODO Find or construct replacements for the swt cursors: Toolkit.createCustomCursor(java.awt.Image, java.awt.Point, java.lang.String)
     */
    private final static int[] systemCursors = {
    	Cursor.CROSSHAIR_CURSOR,  // grid 
    	Cursor.DEFAULT_CURSOR, // error
    	Cursor.CROSSHAIR_CURSOR,
    	Cursor.N_RESIZE_CURSOR,  // up-down NS
    	Cursor.E_RESIZE_CURSOR,  // left-right WE
    	Cursor.DEFAULT_CURSOR, // diag NWSE
    	Cursor.WAIT_CURSOR,
     ...
     */
    private static final String[] customCursors = {"zoom", "hand", "create", "modify"};

    /**
     * The hotspots of the custom cursors for preloading.
     */
    private final static Point[] customCursorHotspots = {new Point(9, 9), new Point(8, 8), new Point(7, 10), new Point(7, 19)};
...
//            cursors[i + systemCursors.length] = new Cursor(Display.getDefault(), safeDataStream("/images/cursors/" + customCursors[i] + ".gif"), customCursorHotspots[i].getX(),
//                    customCursorHotspots[i].getY());
//        }
     ...
     */
    private ImageIcon safeDataStream(String location){
        try{
            return new ImageIcon(location);
        }
        catch(Exception e){
            System.err.println(getString("error.fatal_title") + "\n" + getMessage("error.image_not_found", location));
        }
        return null;
    }
...
//    }
     ...
     * @param msg The key for the message string. The message string must
