...
/**
 * A convenience wrapper of {@link java.util.Properties}. It provides
...
public class PersistentProperties extends Properties {
	 ...
	 * and parses the string value as a boolean.
	 * If the key is not found in this property list, the default property list,
	 * and its defaults, recursively, are then checked. The method returns <code>false</code>
	 ...
	 * Provided for parallelism with the getProperty method. Enforces use of strings
	 * for property keys. Boolean values are properly formatted and stored as strings.
	...
	/**
	 * Searches for the property with the specified key in this property list
	 * and parses the string value as an integer.
	 * If the key is not found in this property list, the default property list,
	 * and its defaults, recursively, are then checked. The method returns <code>0</code>
	 * if the property is not found.
	 * @param key the property key
	 * @return the value in this property list with the specified key value.
	 ...
	 * Calls the Hashtable method put.
	 * Provided for parallelism with the getProperty method. Enforces use of strings
	 * for property keys. Integer values are properly formatted and stored as strings.
	 * The value returned is the result of the Hashtable call to put.
	 * @param key the key to be placed into this property list
	 * @param value the value corresponding to key
	 * @return the previous value of the specified key in this property list,
