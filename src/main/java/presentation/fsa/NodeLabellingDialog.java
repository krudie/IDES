...
public class NodeLabellingDialog extends EscapeDialog {
    ...
    private NodeLabellingDialog() {
        ...
        area.getInputMap(JComponent.WHEN_FOCUSED)
                .put(KeyStroke.getKeyStroke(KeyEvent.VK_ENTER, InputEvent.CTRL_DOWN_MASK), actionKey);
    ...
    public static void showAndLabel(GraphDrawingView gdv, FSAGraph gm, CircleNode node) {
