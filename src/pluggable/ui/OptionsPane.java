 ...
 * own section by calling {@link main.Hub#registerOptionsPane(OptionsPane)} and
 * providing an {@link OptionsPane} as an argument. The set of controls for the
 * module or plugin have to appear in the {@link javax.swing.JPanel} that is
 * returned by the {@link #getPane()} method.
 * <p>
...
public interface OptionsPane
{
	...
	/**
	 * Returns the string which will appear in the list of sections in the
	 * Optins dialog box. The user will identify the options controls in this
	 ...
	 * will be displayed in the Options dialog box when the user selects the
	 * section for this options pane.
	 * <p>
	 * This method may be called numerous times during one session. Do not
	 * construct a new {@link javax.swing.JPanel} for each call unless
	 * {@link #disposePane()} has been called. If {@link #disposePane()} has not
	 * been called, simply pass a reference to the same object.
	 * 
	 ...
	 * This method will usually be invoked when the user chooses to cancel any
	 * choices they have made. The module or plugin must not change behavor.
	 * <p>
	 * This method may be called a number between calls to {@link #getPane()}.
	 * You must not dispose of the {@link OptionsPane} after a call to this
	 * method.
	 * <p>
	 ...
	 * This method will usually be invoked when the user chooses to accept any
	 * choices thay have made. The module or plugin must change behavior
	...
	/**
	 * Called when it is safe to dispose of the {@link javax.swing.JPanel} with
