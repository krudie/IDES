 ...
 * into {@link LayoutShell}s so that they can be visualized.
 *  
...
public interface Toolset {
	...
	/**
	 * Returns a descriptor of the GUI elements which will be
	 * used to display a {@link LayoutShell}.
	 * @param mw the {@link LayoutShell} to be displayed
	 ...
	 * of the given {@link LayoutShell}.
	 * @param mw {@link LayoutShell} for which to return a thumbnail
	 * @param width the desired width of the thumbnail in pixels
	 * @param height the desired height of the thumbnail in pixels
	 * @return a {@link Presentation} element with a thumbnail view of the {@link LayoutShell}
	 * @throws UnsupportedModelException when the toolset does not
	 * support the type of the given {@link LayoutShell}
	 */
	 ...
	 * The toolset may return different implementations of {@link LayoutShell}
	 ...
	 * not support the type of the given {@link DESModel}
	 */
