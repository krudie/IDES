...
public class BentoBox
{
	...
	public static final String STR_ASCII_STANDARD_RETURN = "" + ((char)13)
			+ ((char)10);

	// /////////////////////////////////////////////////////////////////
	// Static Member Functions
	// /////////////////////////////////////////////////////////////////
	public static float getMinValue(float num1, float num2, float num3,
			float num4)
	{
	...
	public static float getMaxValue(float num1, float num2, float num3,
			float num4)
	{
		...
		if (find.length() > 0)
		{
			...
			while (i >= 0 && i < r.length())
			{
				...
				if (i >= 0)
				{
					...
					right_half = (i + find.length() < r.length()) ? r
