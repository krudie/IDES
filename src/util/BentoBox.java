 ...
 * of methods or a bento-box of goodness.
 * 
...
public class BentoBox 
{
	...
	///////////////////////////////////////////////////////////////////
	public static float getMinValue(float num1, float num2, 
	...
	public static float getMaxValue(float num1, float num2, 
			float num3, float num4)
	{
	 ...
	 * be further modified.  Use this when String.replaceAll is 
	 * too complicated (i.e. replace < with $<$)
	 * 
	 * @param	source	The source string.
	 * @param	find	The substring to be found.
	 * @param	replace	The substring to replace all occurences of find.
	 * @return  A modified version of "source" will all occurences of 
	 * 			"find" replaced with "replace".
	 * 
		...
		if (find.length() > 0)
		{
			...
			while(i >= 0 && i < r.length())
			{
				...
				if (i >= 0)
				{
					...
					right_half = (i + find.length() < r.length()) ? 
						r.substring(i + find.length()) : "";
