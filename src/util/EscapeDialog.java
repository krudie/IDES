...
/**
 * A class which extends {@link javax.swing.JDialog} with the capability to handle
 * the event of the user pressing the <code>Escape</code> key. Instead of subclassing
 * {@link javax.swing.JDialog}, subclass {@link EscapeDialog} and override
 * {@link #onEscapeEvent()}.
 * @see #onEscapeEvent()
...
public class EscapeDialog extends JDialog {
	...
	/**
	 * The listener for the user pressing the <code>Escape</code> key.
	 * Calls {@link #onEscapeEvent()}.
	 * @see #onEscapeEvent()
	...
	/**
	 * Called by the constructor to bind {@link #escapeListener} with
	 * the {@link #rootPane} so that the <code>Escape</code> key
	 * can be intercepted.
	 * @see #escapeListener
	 */
	 ...
	 * Override to custom-handle this event.
	 */
