 ...
 * value. Whenever the value changes, all bound elements will be updated
...
public class BooleanUIBinder {
	...
	/**
	 * Registers an {@link AbstractButton} to be updated when the encapsulated Boolean value
	 * changes. 
	 ...
	 * encapsulated Boolean value changes. 
