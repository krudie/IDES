 ...
 *
 *  This is a helper class for the operations.  All operations implement the 
 *  operation methods in the same manner, except for perform, so this class
 *  exists to prevent duplication and ensure code consistency.
 *  
 *  All operations should extend this class for convenience.
 *  
 *  Alternatively, new operations can directly implement the
 *  pluggable.operation.Operation interface if the implementation here is inadequate
 *
 *
 */
