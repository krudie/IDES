...
{
	/**
	 * Finds the accessible part of an automaton The function does not return a
	 * new automaton, so if the original automaton should not be changed, make
	 * sure to copy it first.
	 * 
	 * @param automaton
	 *            The automaton which to find the accessible part of
	 */
	public static void accessible(FSAModel automaton)
	{
		...
		while (!searchList.isEmpty())
		{
			...
			Iterator<FSATransition> transitionIterator = state
	...
	/**
	 * Finds the coaccessible part of an automaton The function does not return
	 * a new automaton, so if the original automaton should not be changed, make
	 * sure to copy it first.
	 * 
	 * @param automaton
	 *            The automaton which to find the coaccessible part of
	 */
	 ...
	 * automaton, so if the original automaton should not be changed, make sure
	 * to copy it first.
	 * 
	 * @param automaton
	 *            The automaton which to trim.
	 */
