...
public class FSAMessage
{
	...
	/**
	 * Creates an FSA modification message to be passed to {@link FSASubscriber}
	 * s.
	 * 
	 * @param eventType
	 *            the type of event (addition, removal or modification)
	 * @param elementType
	 *            the element type (state, transition or event)
	 * @param elementId
	 *            the ID of the element
	 * @param source
	 *            the {@link FSAModel} where the message originates
	 */
