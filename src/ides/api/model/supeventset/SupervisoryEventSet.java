 ...
 */
public interface SupervisoryEventSet extends DESEventSet, DESModel,
		SupEventSetPublisher
{
	/**
	 ...
	 * @return As new SupervisoryEvent with the same name as the given event. If
	 *         the given event is a SupervisoryEvent, the new event will have
	 *         the same controllable and observable properties as the given
	 *         event.
	 */
