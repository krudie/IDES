...
public class Hub
{
	...
	/**
	 * Stores the settings from the list of settings
	 * {@link #getPersistentData()} into the file <code>settings.ini</code>. If
	 * this fails, it shows a message box to the user.
	 */
