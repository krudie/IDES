...
{
	/**
	 * Returns the ID of a child model which can be used to obtain the child
	 * model.
	 * 
	 * @param child
	 *            a child model of the parent model
	 * @return the ID of the child model
	 * @throws IllegalArgumentException
	 *             when the model in the argument is not a child of this model
	 * @see #getChildModel(String)
	 */
	public String getChildModelId(DESModel child)
			throws IllegalArgumentException;
	 ...
	 *         <code>null</code> if this parent model does not contain a child
