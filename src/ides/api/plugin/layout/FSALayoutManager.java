...
public class FSALayoutManager
{
	...
	/**
	 * The indexed set of all registered layouters. The key to the index is the
	 * name of the corresponding layouter.
	 */
	...
	/**
	 * Register an {@link FSALayouter} with IDES. This class will become
	 * available for the layout of {@link FSAModel}s.
	 * <p>
	 * If a layouter with the same name has already been registered, the new
	 * layouter will replace it.
	 * 
	 * @param layouter
	 *            the layouter to be registered
	 */
	...
	/**
	 * Retrieve the layouter with the given name. If no layouter with the given
	 * name has been registered, returns <code>null</code>.
	 * 
	 * @param name
	 *            the name of the layouter
	 * @return the layouter with the given name; or <code>null</code> if no
	 *         layouter with the given name has been registered
	 */
	 ...
	 * 
	 * @param layouter
	 *            the layouter to be registered and used as a default layouter
	 */
