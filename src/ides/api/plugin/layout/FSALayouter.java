...
public interface FSALayouter
{
	 ...
	 * 
	 * @param model
	 *            the {@link FSAModel} whose states should be laid out.
	 * @return a map where the key is the id of a state of the model and the
	 *         value is the location of the state; the map must contain
	 *         locations for all the states in the model; if there are no states
	 *         in the model, return an empty map
	 */
