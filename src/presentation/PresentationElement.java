...
public interface PresentationElement
{
	 ...
	 * 
	 * @param layout
	 *            the layout data to be set
	 */
	public void setLayout(GraphicalLayout layout);

	/*
	 * FIXME Don't want layout to be tampered with directly, should be guarded
	 * by its GraphElement to control nature and timing of updates.
	 */
	/**
	...
	/**
	 * Refreshes this element's display characteristics from its underlying
	 * data.
	 */
	public void refresh();
