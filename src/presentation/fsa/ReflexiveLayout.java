...
public class ReflexiveLayout extends BezierLayout implements Serializable
{
	 ...
	 * midpoint of this edge. FIXME the axis doesn't reach the *computed*
	 * midpoint.
	 */
	 ...
	 * NOTE this looks ugly but minimizes the problem of control (mid)point
	 * drift
	 */
	public static final double DEFAULT_ANGLE = Math.PI / 4;

	/**
	 * Default value to scale the centre axis vector to the length of the
	 * tangents of the bezier curve
	 */
	public static final float DEFAULT_SCALAR = 2f;

	/**
	 * Layout for a reflexive edge with vertical axis vector from centre of node
	 * to midpoint of bezier curve given by <code>bLayout</code>.
	 */
	...
	public Point2D.Float computeBestDirection(Node target)
	{
		...
		{
			return Geometry
					.rotate(new Point2D.Float(1, 0), Math.toRadians(-90));
		}
	...
	/**
	 * Returns true iff <code>o</code> is an instance of ReflexiveLayout and
