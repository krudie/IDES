...
public abstract class DrawingTool
{
	 ...
	 * "move" tool can respond correctly when the graph is too large and the
	 * mouse is moved too fast to detect where exactly the dragging has started.
	 */
	...
	public void handleRightClick(MouseEvent m)
	{
		...
		if (ContextAdaptorHack.context.updateCurrentSelection(m.getPoint()))
		{
			ContextAdaptorHack.context
					.getSelectedElement().showPopup(ContextAdaptorHack.context);
		}
		else
		{
