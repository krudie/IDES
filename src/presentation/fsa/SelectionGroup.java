...
public class SelectionGroup extends GraphElement implements Transferable
{
	...
	/**
	 * Test and flag edges before moving the group. For all e in the selection
	 * group If both s and t are in this group, flag e as a simple translation
	 * otherwise e will need to be recomputed to preserve its shape when only
	 * one of its edges is moved. Then translates all nodes (nodes will see to
	 * moving their edges)
	 */
