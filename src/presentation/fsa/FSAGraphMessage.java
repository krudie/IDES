...
public class FSAGraphMessage
{
	 ...
	 *            message sender
	 */
	public FSAGraphMessage(int eventType, int elementType, long elementId,
			Rectangle2D location, FSAGraph source)
	{
	 ...
	 */
	public FSAGraphMessage(int eventType, int elementType, long elementId,
			Rectangle2D location, FSAGraph source, String message)
	{
		super();
		this.source = source;
