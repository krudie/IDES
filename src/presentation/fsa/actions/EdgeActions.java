...
public class EdgeActions
{
	...
	public static class LabelAction extends AbstractGraphAction
	{
		...
		public void actionPerformed(ActionEvent event)
		{
			if (edge != null)
			{
				GraphUndoableEdits.UndoableEdgeLabel action = new GraphUndoableEdits.UndoableEdgeLabel(
						graph,
						edge,
						assignedEvents);
				action.redo();
	...
	public static class ModifyAction extends AbstractGraphAction
	{
		...
		public ModifyAction(FSAGraph graph, Edge edge,
				GraphicalLayout originalLayout)
		{
			this(null, graph, edge, originalLayout);
		}

		public ModifyAction(CompoundEdit parentEdit, FSAGraph graph, Edge edge,
				GraphicalLayout originalLayout)
		{
			this.graph = graph;
			this.edge = edge;
		...
		/**
		 * Instantiate the UndoableAction of interest, sending references to the
		 * Edge, the GraphDrawingView * and the backup for the layout of the
		 * edge. * Reports the UndoableAction to the CommandManager.
		 */
		public void actionPerformed(ActionEvent evt)
		{
			if (graph != null)
			{
				UndoableEdit edit = new GraphUndoableEdits.UndoableModifyEdge(
						graph,
						edge,
						originalLayout);
	...
	public static class SymmetrizeAction extends AbstractGraphAction
	{
		...
		public SymmetrizeAction(CompoundEdit parentEdit, FSAGraph graph,
				Edge edge)
		{
			this.graph = graph;
			this.edge = edge;
	...
	public static class StraightenAction extends AbstractGraphAction
	{
		...
		public StraightenAction(CompoundEdit parentEdit, FSAGraph graph,
				Edge edge)
		{
			this.graph = graph;
			this.edge = edge;
