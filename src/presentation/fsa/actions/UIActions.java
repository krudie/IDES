...
public class UIActions
{
	...
	/**
	 * Represent a user issued command to delete an element of the graph. What
	 * about deleting elements of a text label?
	 * 
	 * @author helen bretzke
	 */
	public static class DeleteAction extends AbstractAction
	{
		...
		{
			if (((CreationTool)context.getTools()[GraphDrawingView.CREATE])
					.isDrawingEdge())
			{
				((CreationTool)context.getTools()[GraphDrawingView.CREATE])
						.abortEdge();
			}
	...
	public static class ModifyInitialAction extends AbstractAction
	{
		...
		public void actionPerformed(ActionEvent e)
		{
			new NodeActions.SetInitialAction(graph, node, !node
					.getState().isInitial()).execute();
		}
	...
	public static class ModifyMarkingAction extends AbstractAction
	{
		...
		public void actionPerformed(ActionEvent e)
		{
			new NodeActions.SetMarkingAction(graph, node, !node
					.getState().isMarked()).execute();
		}
