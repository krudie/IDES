...
public class GraphUndoableEdits
{
	 ...
	 * over a Graph. In order to do that, the SelectionGroup and a vector
	 * representing the displacement are sent in the class constructor.
	 * 
	...
	public static class UndoableMove extends AbstractGraphUndoableEdit
	{
		 ...
		 */
		public UndoableMove(FSAGraph graph, GraphElement element,
				Point2D.Float d)
		{
			this.graph = graph;
			this.element = element;
		...
		/**
		 * Undoes a movement by applying a vector opposite to
		 * <code>displacement</code> over <code>collection</code>
		 */
		@Override
		public void undo() throws CannotUndoException
		{
	...
	public static class UndoableCreateEvent extends AbstractGraphUndoableEdit
	{
		...
		public UndoableCreateEvent(FSAGraph graph, String eventName,
		...
		public void redo() throws CannotRedoException
		{
			...
			if (event == null)
			{
				event = graph.createAndAddEvent(eventName,
						controllable,
						observable);
			}
			else
	...
	public static class UndoableModifyEdge extends AbstractGraphUndoableEdit
	{
		...
		public UndoableModifyEdge(FSAGraph graph, Edge edge,
				GraphicalLayout originalLayout)
		{
			this.graph = graph;
			this.edge = edge;
	...
	public static class UndoableModifyInitialArrow extends
			AbstractGraphUndoableEdit
	{
		...
		public UndoableModifyInitialArrow(FSAGraph graph, InitialArrow arrow,
		...
		{
			Point2D.Float tDirection = (Point2D.Float)arrow
					.getDirection().clone();
	...
	public static class UndoableTranslateGraph extends
			AbstractGraphUndoableEdit
	{
		/**
		 * 
	...
	public static class UndoableUniformNodeSize extends
			AbstractGraphUndoableEdit
	{
		/**
		 * 
