...
public abstract class Node extends GraphElement
{
	...
	/**
	 * Returns the shape that visually represents this Node in a graphical
	 * display.
	 * 
	 * @return the shape that visually represents this Node in a graphical
	 *         display
	 */
	...
	/**
	 * Returns an iterator of all edges adjacent to this node, i.e. have this
	 * node as either source or target.
	 * 
	...
	/**
	 * Return a bounding rectangle for the union of this Node with all of its
	 * child elements (e.g. edges and label).
	 * 
	...
	/**
	 * Sets the location of this Node to p and adjusts the location of all
	 * adjacent edges.
	 * 
	 * @param p
	 *            the new location
	...
	/**
	 * Sets my state's initial property to <code>b</code> and activates my
	 * initial arrow.
	 * 
	 * @param b
	 */
	 ...
	 * elements. If already have an initial arrow in my set of children, removes
	 * it.
	 * 
	 * @param initialArrow
	 */
