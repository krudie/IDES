...
{
	public static class UndoableCreateEvent extends
			AbstractSupEventSetUndoableEdit
	{
		...
		public UndoableCreateEvent(SupervisoryEventSet model, String eventName,
	...
	public static class UndoableRemoveEvent extends
			AbstractSupEventSetUndoableEdit
	{
		...
		public UndoableRemoveEvent(SupervisoryEventSet model,
	...
	public static class UndoableModifyEvent extends
			AbstractSupEventSetUndoableEdit
	{
		...
		public UndoableModifyEvent(SupervisoryEventSet model,
				SupervisoryEvent event, String newName,
