 ...
 */
public class SupEventSetView extends JPanel implements Presentation,
		SupEventSetSubscriber, CopyPastePresentation, ClipboardOwner
{
	...
	protected class EventTableModel extends AbstractTableModel
	{
		...
		public EventTableModel(SupervisoryEventSet a)
		{
			...
			observable = new Vector<Boolean>();
			this.a = a;
			for (Iterator<SupervisoryEvent> i = a.iteratorSupervisory(); i
					.hasNext();)
			{
				events.add(i.next());
			}
		...
		public void setValueAt(Object value, int row, int col)
		{
			...
			if (col == 0)
			{
				...
				new SupEventSetActions.ModifyEventAction(a, events
			...
			{
				new SupEventSetActions.ModifyEventAction(
						a,
	...
	protected Action deleteListener = new AbstractAction()
	{
		...
		public void actionPerformed(ActionEvent actionEvent)
		{
			...
			for (int i = 0; i < delEvents.length; ++i)
			{
				...
				AbstractSupEventSetAction deleteEvent = new SupEventSetActions.RemoveEventAction(
						allEdits,
						model,
						delEvents[i]);
	...
	protected Action createListener = new AbstractAction()
	{
		...
		public void actionPerformed(ActionEvent actionEvent)
		{
			...
			SupervisoryEventSet a = (SupervisoryEventSet)Hub
			...
			new SupEventSetActions.CreateEventAction(
					model,
					eventName,
	...
	public boolean isPasteEnabled()
	{
		if (Hub
				...
				.isDataFlavorAvailable(EventSetWrapper.eventSelectionFlavor))
		{
			return true;
		}
	...
	protected class EventPasteAction extends AbstractAction
	{
		...
		public void actionPerformed(ActionEvent arg0)
		{
			Transferable clipboardContent = Hub
					.getCopyPasteManager().getClipboard()
					.getContents(SupEventSetView.this);
