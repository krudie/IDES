 ...
 * 
 * NOTE 
 * This class was originally intended as a way to pack and pass all graphical layout information
 * between the Automaton and elements of the FSAGraph via the MetaData class.  This will no longer be necessary
 * once graphcial layout metadata is read and stored directly in the FSAGraph (on its initialization) and written
 * directly from the FSAGraph on save.
 * 
...
public class GraphicalLayout implements Serializable{
	...
	/**
	 * Returns the  x and y coordinates of the associated element on the graph canvas. 
	 *  
	...
	/**
	 * Returns the vector representing the displacement of the label
	 * from the location of graphical element.
	 *   
	...
	/**
	 * Sets the vector representing the displacement of the label
	 * from the location of the graphical element.
	 *   
