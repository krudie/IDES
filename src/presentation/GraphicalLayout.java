...
public class GraphicalLayout implements Serializable
{
	...
	public static final Stroke WIDE_DASHED_STROKE = new BasicStroke(
			2,
			BasicStroke.CAP_BUTT,
			BasicStroke.JOIN_MITER,
			50,
	 ...
	 */
	public GraphicalLayout(Point2D.Float location, String text, Color color,
	 ...
	 *            the selection colour to be set
	 */
	...
	/**
	 * Sets the vector representing the displacement of the label from the
	 * location of the graphical element.
	 * 
	 * @param labelOffset
	 *            offset of the label from its associated graphical element
	 */
