...
//		JScrollPane sPane=new JScrollPane(area);
	...
	public static void showAndLabel(DesignDrawingView context, TemplateGraph gm, GraphBlock block,
			SelectionTool tool)
	{
		graph=gm;
		BlockLabellingDialog.block=block;
		Point p=new Point((int)block.getLocation().x,
				(int)block.getLocation().y);
		instance();
		me.pack();
