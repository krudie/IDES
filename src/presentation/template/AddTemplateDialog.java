...
public class AddTemplateDialog extends EscapeDialog implements ActionListener {
		...
		eventList.addListSelectionListener(new ListSelectionListener()
		{
			public void valueChanged(ListSelectionEvent e)
			{
				if(e.getValueIsAdjusting()||eventList.isSelectionEmpty())
					return;
				((JCheckBox)eventList.getSelectedValue()).setSelected(
						!((JCheckBox)eventList.getSelectedValue()).isSelected());
	...
	public Template createTemplate()
	{
		...
		FSAModel fsa=(FSAModel)Hub.getWorkspace().getModel((String)fsaList.getSelectedItem());
	...
	protected void updateEvents()
	{
		...
		if(fsaList.getSelectedItem()!=null&&
				!"".equals((String)fsaList.getSelectedItem()))
		{
			FSAModel fsa=(FSAModel)Hub.getWorkspace().getModel((String)fsaList.getSelectedItem());
