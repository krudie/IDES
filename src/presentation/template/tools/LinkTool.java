...
public class LinkTool extends DrawingTool implements ActionListener
{
	...
	public void handleMouseMoved(MouseEvent m)
	{
		...
		// blocks=((TemplateGraph)context.getLayoutShell()).getBlocks();
	...
	public void actionPerformed(ActionEvent ae)
	{
		...
		GraphBlock block = context.getBlockAt(new Point2D.Float(menuThread
				.getOrigin().x, menuThread.getOrigin().y));
		if (block == null)
		{
			return;
		}
