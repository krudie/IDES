...
public class DesignDrawingView extends DesignView implements MouseListener,
		MouseMotionListener, KeyListener
{
	 ...
	 * 
	 */
	private static final long serialVersionUID = 8543817967998037663L;
	...
	protected DrawingTool[] drawingTools = new DrawingTool[] {
			new MovementTool(), new SelectionTool(), new LinkTool() };
	...
	public void paint(Graphics g)
	{
		...
		if (linkStart != null && linkEnd != null)
		{
			...
			g2d.drawLine((int)linkStart.getLocation().x, (int)linkStart
					.getLocation().y, linkEnd.x, linkEnd.y);
		}
	}
