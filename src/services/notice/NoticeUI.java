...
public class NoticeUI extends JPanel
{
	 ...
	 * 
	 * @param n
	 *            the notice to be represented by the UI element
	 */
	 ...
	 * 
	 * @param b
	 *            if <code>true</code> expand the notice, else collapse it
	 */
	 ...
	 * 
	 * @return <code>true</code> if the notice is expanded, else
	 *         <code>false</code>
	 */
	 ...
	 * 
	 * @param b
	 *            if <code>true</code> the notice gets highlighted, else it gets
	 *            de-highlighted
	 */
	public void setHighlight(boolean b)
	{
		...
		{
			setBackground((ColorUIResource)UIManager
					.getDefaults().get("Panel.background"));
			tb.setBackground((ColorUIResource)UIManager
					.getDefaults().get("Panel.background"));
			disposeButton.setBackground((ColorUIResource)UIManager
					.getDefaults().get("Panel.background"));
		}
	}
}
