...
/**
 * The UI element (representation) of a notice. It can have one of two states, expanded and
 * collapsed, and it can be highlighted.
...
public class NoticeUI extends JPanel
{
	 ...
	 */
	public final static Icon ICON_INFO=new ImageIcon(Toolkit.getDefaultToolkit().createImage(
			Hub.getResource("images/icons/notice_info.gif")));
	/**
	 * Icon for "warning" notices.
	 */
	public final static Icon ICON_WARN=new ImageIcon(Toolkit.getDefaultToolkit().createImage(
			Hub.getResource("images/icons/notice_warn.gif")));
	/**
	 * Icon for "error" notices.
	 */
	public final static Icon ICON_ERROR=new ImageIcon(Toolkit.getDefaultToolkit().createImage(
			Hub.getResource("images/icons/notice_error.gif")));
	/**
	...
	public NoticeUI(Notice n)
	{
		...
		disposeButton=new JButton(MetalIconFactory
	 ...
	 * @param b if <code>true</code> the notice gets highlighted, else it gets de-highlighted
	 */
