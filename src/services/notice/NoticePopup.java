 ...
 */
public class NoticePopup extends JDialog implements WindowListener,
		ComponentListener, MouseListener
{
	...
	/**
	 * Defines the number of milliseconds after which the popup of a notice
	 * should expire.
	 */
	 ...
	 * Notices posted earlier than this time will not be displayed in the
	 * balloon.
	 */
	...
	private NoticePopup()
	{
		...
		JButton disposeButton = new JButton(MetalIconFactory
	...
	/**
	 * Initializes the NoticePopup. Should be called only once during the
	...
	/**
	 * Aligns the pop-up balloon with the position and the size of the main
	 * window.
	 */
	...
	/**
	 * When the main window is activated (e.g., user brings it to the
	 * foreground), also make the pop-up balloon visible.
	 */
	...
	/**
	 * When the main window is deactivated (e.g., user sends it to the
	 * background), hide the pop-up balloon.
	 */
	...
	/**
	 * When the main window is deiconified, also make the pop-up balloon
	 * visible.
	 */
			...
			public void run()
			{
				...
				for (int i = notices.size() - 1; i >= 0; --i)
				{
					if (System.currentTimeMillis()
							- notices.elementAt(i).timeStamp < POPUP_EXPIRY_MSEC
	...
	/**
	 * If the user clicks anywhere in the pop-up balloon, the balloon gets
	 * hidden. If the user does not click on the close button of the balloon,
	 * the {@link NoticeBoard} with all the notices is activated in the main
	 * window.
	 */
