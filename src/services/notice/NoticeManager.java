...
public class NoticeManager
{
	...
	/**
	 * Cleans up resources, notifies the thread for expired notices to
	 * terminate. Should be called only once when closing the program.
	 */
	...
	/**
	 * Posts an information notice which automatically expires if it is not
	 * revoked or if the user does not discard it sooner.
	 * 
	 * @param digest
	 *            a short summary of the notice
	 * @param fullBody
	...
	/**
	 * Posts an error notice which automatically expires if it is not revoked or
	 * if the user does not discard it sooner.
	 * 
	 * @param digest
	 *            a short summary of the notice
	 * @param fullBody
	...
	/**
	 * Posts an error notice which does not automatically expire. It disappears
	 * only if it is revoked or if the user discards it.
	 * 
	 * @param digest
	 *            a short summary of the notice
	 ...
	 *            the complete text of the notice
	 * @param type
	 *            type of the notice (info, warning, error)
	 * @param isTemporary
	 *            <code>true</code> if notice should expire automatically,
	 *            <code>false</code> otherwise
	 * @return the ID of the notice which can be used to revoke it
	 */
	protected synchronized static int postNotice(String digest,
			String fullBody, int type, boolean isTemporary)
	{
		Notice n = new Notice();
		n.digest = digest;
		n.fullBody = fullBody;
	 ...
	 * 
	 * @param id
	 *            the ID of the notice to be revoked
	 */
