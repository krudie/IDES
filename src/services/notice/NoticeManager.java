...
/**
 * Manager of messages displayed to the user. Three types of notices are supported:
...
public class NoticeManager
{
	...
	/**
	 * Defines the number of milliseconds after which a temporary notice should expire.
	 */
	...
	/**
	 * Initializes the Notice Manager. Should be called only once
		...
		expiryWatch=new Thread(new Runnable()
		{
			public void run()
			{
				while(true)
				{
					...
					{
						if(n.isTemporary&&!n.uiElement.isExpanded()&&System.currentTimeMillis()-n.timeStamp>AUTO_EXPIRY_MSEC)
						{
							toRemove.add(n.id);
						}
					}
	 ...
	 */
	public static int postInfoTemporary(String digest,String fullBody)
	{
		return postNotice(digest,fullBody,Notice.INFO,true);
	}

	/**
	 * Posts an information notice which does not automatically expire.
	 * It disappears only if it is revoked or if the user discards it. 
	 * @param digest a short summary of the notice
	 * @param fullBody the complete text of the notice
	 * @return the ID of the notice which can be used to revoke it
	 * @see #revoke(int)
	 ...
	 */
	public static int postInfoUntilRevoked(String digest,String fullBody)
	{
		return postNotice(digest,fullBody,Notice.INFO,false);
	}
	
	/**
	 * Posts a warning notice which automatically expires if it is not revoked
	 * or if the user does not discard it sooner. 
	 * @param digest a short summary of the notice
	 * @param fullBody the complete text of the notice
	 * @return the ID of the notice which can be used to revoke it
	 ...
	 */
	public static int postWarningTemporary(String digest,String fullBody)
	{
		return postNotice(digest,fullBody,Notice.WARNING,true);
	}

	/**
	 * Posts a warning notice which does not automatically expire.
	 * It disappears only if it is revoked or if the user discards it. 
	 * @param digest a short summary of the notice
	 * @param fullBody the complete text of the notice
	 * @return the ID of the notice which can be used to revoke it
	 ...
	 * @see #postInfoTemporary(String, String)
	 */
	public static int postWarningUntilRevoked(String digest,String fullBody)
	{
		return postNotice(digest,fullBody,Notice.WARNING,false);
	}
	
	/**
	 * Posts an error notice which automatically expires if it is not revoked
	 * or if the user does not discard it sooner. 
	 * @param digest a short summary of the notice
	 * @param fullBody the complete text of the notice
	 * @return the ID of the notice which can be used to revoke it
	 ...
	 */
	public static int postErrorTemporary(String digest,String fullBody)
	{
		return postNotice(digest,fullBody,Notice.ERROR,true);
	}

	/**
	 * Posts an error notice which does not automatically expire.
	 * It disappears only if it is revoked or if the user discards it. 
	 * @param digest a short summary of the notice
	 * @param fullBody the complete text of the notice
	 * @return the ID of the notice which can be used to revoke it
	 ...
	 * @see #postInfoTemporary(String, String)
	 */
	public static int postErrorUntilRevoked(String digest,String fullBody)
	{
	 ...
	 * @param isTemporary <code>true</code> if notice should expire automatically, <code>false</code> otherwise
	 * @return the ID of the notice which can be used to revoke it
	 */
	protected synchronized static int postNotice(String digest,String fullBody,int type,boolean isTemporary)
	{
		Notice n=new Notice();
		n.digest=digest;
		n.fullBody=fullBody;
	...
	/**
	 * Revokes a notice. If the notice with given ID does not exist, the method
	 * call is ignored.
	 * @param id the ID of the notice to be revoked
	 */
	public synchronized static void revoke(int id)
	{
		int toRemove=-1;
	 ...
	 */
	public synchronized static Vector<Notice> getNotices()
	{
