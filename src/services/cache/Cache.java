...
public class Cache {
	 ...
	 * cache has not been used for longer than this period of time (in seconds),
	 * it will be deleted when the cache is closed.
	 * @see #close()
	 */
	 ...
	 * <p>After a call to this method, the cache should not be used unless {@link #init()}
	 * is called again.
	 * @see #init()
	 */
