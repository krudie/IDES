...
/**
 * This object renders all labels in a DES model and displays the progress in a
 * dialog box with a progress bar. The rendering can be interrupted by the user.
 * <p>
...
public class LatexPrerenderer extends InterruptableProgressDialog
{
	 ...
	 * of a {@link FSAGraph}. The user may cancel the process using the
	 * controls in the dialog box.
	 * 
	 * @param model
	 *            the DES model whose labels have to be rendered
	 */
	...
	/**
	 * Displays a dialog box with a progress bar and starts rendering the labels
	 * of a set of {@link FSAGraph}s. The user may cancel the process using the
	 * controls in the dialog box.
	 * 
	 * @param models
	 *            an iterator over the set of DES models whose labels have to be
	 *            rendered
	 */
