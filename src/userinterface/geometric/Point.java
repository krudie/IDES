...
/**
 * This class represents a point in cartesian space. It provides many methods
 * for creating new points based on itself. For example, you can create a new
 * Point a given distance along a given direction from this Point.
 * 
 * @author Michael Wood
 */
public class Point {
     ...
     * 
     * @param coords
     *            A String representation of integer co-ordinates. i.e. (5,4)
     */
    ...
    public Point newPoint(UnitVector direction, float distance) {
        return new Point((int) Math.round(this.x + distance * direction.x),
                (int) Math.round(this.y + distance * direction.y));
    }
