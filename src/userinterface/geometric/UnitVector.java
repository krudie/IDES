...
/**
 * This class represents a unit vector in cartesian space. It provides many
 * methods to manipulate itself, or to produce manipulated versions of itself.
...
public class UnitVector {
    ...
    /**
     * Change this to a new UnitVector, in the reverse direction to the
     * origional.
     */
    public void reverse() {
        x = -x;
