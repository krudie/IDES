...
{	
	...
	{		
		...
		shell.setSize(SystemVariables.floating_text_size.x,SystemVariables.floating_text_size.y);
		...
		msg.setText(ResourceManager.getString("floating.usage.text"));

		CLabel sizer = new CLabel(cmp, SWT.RIGHT);
		sizer.setLayoutData(new GridData(GridData.HORIZONTAL_ALIGN_END));
		sizer.setImage(ResourceManager.getImage(ResourceManager.DRAG));
