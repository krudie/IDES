...
public class Node extends GraphObject {
     ...
     */
	private Node(GraphingPlatform gp, GraphModel gm, int x, int y, int r, int attributes, float arrow_x, float arrow_y, GlyphLabel glyph_label)
	{ 
     ...
     */
	public Node(GraphingPlatform gp, GraphModel gm, int x, int y, int r, int attributes, float arrow_x, float arrow_y, String glyph_string)
	{ 
		super(gp, gm, attributes); 
		this.x = x; 
		this.y = y; 
	...
	public Node newClone()
	{
		...
		last_clone = new Node(gp, null, x, y, r, attributes, start_arrow_direction.x, start_arrow_direction.y, glyph_label);
		return last_clone;
	}	
