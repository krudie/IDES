...
/**
 * This class remembers the origional configuration of a Node or an Edge.
 * It is used in movement, etc. for the purpose of preventing loss of resolution due
...
public class Configuration 
{
     ...
     * The curve points.
     */
	public Point tail_anchor = null,
				 tail_ctrl = null,
				 head_ctrl = null,
				 head_anchor = null,
				 label_displacement = null,
	...
	/**
     * The number of degrees by which the movement origin was off the movement target.
     */
     ...
     * Construct the Configuration.
     * 
     * @param	origin				The origin of the circle of interest (the node connected to the currently manipulated anchor/ctrl points).
     ...
     * @param	label_displacement	The displacement of the top-left of the label from the mid-point of the curve
     * @param	movement_origin		The mouse-click origin of movement.
     * @param	selection_target	The target that the mouse-click was supposed to hit.
     * @param	state_mask			The state mask of the mouse event that created the configuration.
     */
	public Configuration(Point origin, Point tail_anchor, Point tail_ctrl, Point head_ctrl, Point head_anchor, Point label_displacement, Point movement_origin, Point selection_target, int state_mask)
	{
		this.origin = origin.getCopy();
		...
		selection_error_fix = -Geometric.calculateDegrees(movement_origin, origin, selection_target);
	}
}