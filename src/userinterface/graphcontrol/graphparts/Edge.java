...
public class Edge extends GraphObject
{
     ...
     */
	private Edge(GraphingPlatform gp, GraphModel gm, Node start_node, Node end_node, Curve curve, Point label_displacement, int a, Vector label_data, GlyphLabel glyph_label)
	{
		super(gp, gm, a); 
		constructEdge(start_node, end_node); 
	...
	public Edge newClone()
	{
		if (n1.last_clone != null && n2.last_clone != null)
		{
			...
			return new Edge(gp, null, n1.last_clone, n2.last_clone, curve.newClone(n1.last_clone, n2.last_clone), label_displacement.getCopy(), clone_attribute, getLabelDataVector(), glyph_label);
		}
		else { return null; }
	}
