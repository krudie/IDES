...
public abstract class Label {
     ...
     */
    public static final int CENTER = 0, CORNER = 1;

    /**
     * The factor by which the bounding box of the label is grown in order for
     * drawing to look nice.
     */
    public static final int BOUNDING_BOX_FACTOR = 4;

    /**
     * The factor by which the rendered radius of the label is grown in order
     * for drawing to look nice.
     */
    ...
    /**
     * The Point that anchors the rendered Label. If anchor_type = CENTER, then
     * the rendered Label should be centered at the anchor. If anchor_type =
     * CORNER, then the rendered Label should have the point at it's top left
     * corner.
     */
     ...
     * @param anchor_type
     *            Determines how the anchor should be interpreted.
     * @param rendered_radius
     *            The rendered radius if known (as in cloning). Should be set to
     *            MINIMUM_RADIUS otherwise.
     */
    public Label(GraphingPlatform gp, GraphObject parent,
     ...
     */
    public boolean isLatexLabel() {
        return (this.getClass().getName() == LATEX_CLASS);
    }
     ...
     */
    public boolean isGlyphLabel() {
        return (this.getClass().getName() == GLYPH_CLASS);
    }
    ...
    /**
     * An optional drawing method. Implementations without any special drawing
     * needs should use this method to recall drawLabel.
     * 
     * @param drawer
     *            The Drawer that will handle the drawing.
     * @param data
