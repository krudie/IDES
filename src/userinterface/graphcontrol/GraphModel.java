...
public class GraphModel 
{
	...
	{		
		...
		if (gp.gc.draw_grid && SystemVariables.grid > 0)
		{
			...
			Point offset = new Point(grid_displacement.x % SystemVariables.grid, grid_displacement.y % SystemVariables.grid);
		...
		{ 
			...
			e.draw(drawer, (SystemVariables.show_all_edges && ok_tool), (SystemVariables.show_all_labels && ok_tool)); 
		}
	...
	private Point snappedToGrid(Point p)
	{
		...
		if (SystemVariables.grid > 0) 
		{
			...
			if (difference != 0)
			{
				if (difference > SystemVariables.grid/2) { r.x = p.x + SystemVariables.grid - difference; }
			...
			if (difference != 0)
			{
				if (difference > SystemVariables.grid/2) { r.y = p.y + SystemVariables.grid - difference; }
	...
	public Point snapToGrid(Point p)
	{
		...
		if (SystemVariables.grid > 0) 
		{
			...
			if (difference != 0)
			{
				if (difference > SystemVariables.grid/2) { snaped.x = p.x + SystemVariables.grid - difference; }
			...
			if (difference != 0)
			{
				if (difference > SystemVariables.grid/2) { snaped.y = p.y + SystemVariables.grid - difference; }
