...
public class ProjectExplorer {
    ...
    public void updateProject() {
        ...
        project
                .setText(Userinterface.getProjectPresentation()
                        .getProjectName());
        project.setImage(ResourceManager
                .getHotImage(ResourceManager.FILE_NEW_PROJECT));
        ...
        if (automataNames != null) {
            ...
            for (int i = 0; i < automataNames.length; i++) {
                ...
                automata[i].setImage(ResourceManager
                        .getHotImage(ResourceManager.FILE_NEW_AUTOMATON));
            }
        }
    ...
    private class ProjectListener implements Listener {
        ...
        public void handleEvent(Event event) {
            ...
            case SWT.MouseDown:
                ...
                } else if (event.button == 3 && item != null
                        && item.equals(project)) {
