...
public class GraphicListener extends AbstractListener{
     ...
     * 
     * @param shell The shell in which this ListenersGraph will exist.
     */
    ...
    public SelectionListener getListener(String resource_handle){
        if(resource_handle.equals(ResourceManager.GRAPHIC_ZOOM)){
        ...
        if(resource_handle.equals(ResourceManager.GRAPHIC_CREATE)){
            return new SelectionAdapter(){
                public void widgetSelected(SelectionEvent e){
                    create(e);
                }
        ...
        if(resource_handle.equals(ResourceManager.GRAPHIC_MODIFY)){
            return new SelectionAdapter(){
                public void widgetSelected(SelectionEvent e){
                    modify(e);
                }
        ...
        if(resource_handle.equals(ResourceManager.GRAPHIC_GRAB)){
            return new SelectionAdapter(){
                public void widgetSelected(SelectionEvent e){
                    grab(e);
                }
        ...
        if(resource_handle.equals(ResourceManager.GRAPHIC_GRID)){
            return new SelectionAdapter(){
                public void widgetSelected(SelectionEvent e){
                    grid(e);
                }
        ...
        if(resource_handle.equals(ResourceManager.GRAPHIC_ALLEDGES)){
            return new SelectionAdapter(){
                public void widgetSelected(SelectionEvent e){
                    toggleAllEdges(e);
                }
        ...
        if(resource_handle.equals(ResourceManager.GRAPHIC_ALLLABELS)){
            return new SelectionAdapter(){
                public void widgetSelected(SelectionEvent e){
                    toggleAllLabels(e);
                }
    ...
    public void deselect(){
        if(MainWindow.getGraphingPlatform().gc.selected_tool == MainWindow.getGraphingPlatform().gc.ZOOM_TOOL){
            MainWindow.getGraphingPlatform().mc.graphic_zoom.setSelection(false);
        }
        else if(MainWindow.getGraphingPlatform().gc.selected_tool == MainWindow
                .getGraphingPlatform().gc.CREATE_TOOL){
            MainWindow.getGraphingPlatform().mc.graphic_create.setSelection(false);
        }
        else if(MainWindow.getGraphingPlatform().gc.selected_tool == MainWindow
                .getGraphingPlatform().gc.MODIFY_TOOL){
            MainWindow.getGraphingPlatform().mc.graphic_modify.setSelection(false);
        }
        else if(MainWindow.getGraphingPlatform().gc.selected_tool == MainWindow
                .getGraphingPlatform().gc.GRAB_TOOL){
            MainWindow.getGraphingPlatform().mc.graphic_grab.setSelection(false);
        }
    }
    ...
    /**
     * If the grid dropdown value has changed, then the graphs grid value will
     * be updated. If the grid button has been pressed, then the grid will
    ...
    public void toggleAllEdges(org.eclipse.swt.events.SelectionEvent e){
        ...
        MainWindow.getGraphingPlatform().mc.graphic_alledges
                .setSelection(SystemVariables.show_all_edges);
        MainWindow.getGraphingPlatform().gc.repaint();
    }
    ...
    public void toggleAllLabels(org.eclipse.swt.events.SelectionEvent e){
        ...
        MainWindow.getGraphingPlatform().mc.graphic_alllabels
                .setSelection(!SystemVariables.show_all_labels);
        MainWindow.getGraphingPlatform().gc.repaint();
    }
}
