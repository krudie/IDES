...
public class GraphicListener extends AbstractListener {
     ...
     *            The platform in which this ListenersGraph will exist.
     */
    ...
    public void deselect() {
        if (MainWindow.getGraphingPlatform().gc.selected_tool == MainWindow
                .getGraphingPlatform().gc.ZOOM_TOOL) {
            MainWindow.getGraphingPlatform().mc.graphic_zoom
                    .setSelection(false);
        } else if (MainWindow.getGraphingPlatform().gc.selected_tool == MainWindow
                .getGraphingPlatform().gc.CREATE_TOOL) {
            MainWindow.getGraphingPlatform().mc.graphic_create
                    .setSelection(false);
        } else if (MainWindow.getGraphingPlatform().gc.selected_tool == MainWindow
                .getGraphingPlatform().gc.MODIFY_TOOL) {
            MainWindow.getGraphingPlatform().mc.graphic_modify
                    .setSelection(false);
        } else if (MainWindow.getGraphingPlatform().gc.selected_tool == MainWindow
                .getGraphingPlatform().gc.GRAB_TOOL) {
            MainWindow.getGraphingPlatform().mc.graphic_grab
                    .setSelection(false);
        }
    }
