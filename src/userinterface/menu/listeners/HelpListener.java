...
public class HelpListener extends AbstractListener {
    ...
    public SelectionListener getListener(String resource_handle) {
        if (resource_handle.equals(ResourceManager.HELP_HELPTOPICS)) {
        ...
        if (resource_handle.equals(ResourceManager.HELP_ABOUT)) {
            return new SelectionAdapter() {
                public void widgetSelected(SelectionEvent e) {
                    about(e);
                }
        ...
        try {
            Runtime.getRuntime().exec(
                    "rundll32 url.dll,FileProtocolHandler "
                            + ResourceManager.getString("help.topics.url"));
        } catch (Exception ex) {
            ex.printStackTrace();
        }
    }
    ...
    public void about(org.eclipse.swt.events.SelectionEvent e) {
        ...
        GridData gd_data = new GridData(GridData.HORIZONTAL_ALIGN_FILL
        ...
        GridData gd_message = new GridData(GridData.HORIZONTAL_ALIGN_FILL
