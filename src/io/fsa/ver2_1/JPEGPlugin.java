...
public class JPEGPlugin implements ImportExportPlugin {
	...
	{    	
    	...
    	FSAGraph graph=(FSAGraph)PresentationManager.getToolset(FSAModel.class).wrapModel(a);
    	...
    	BufferedImage image=new BufferedImage(bounds.width,bounds.width,BufferedImage.TYPE_INT_RGB);
