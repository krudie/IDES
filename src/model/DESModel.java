...
public interface DESModel extends Annotable, DESModelPublisher {
	 ...
	 * <code>false</code> otherwise. This method should also
	 * consider changes to the associated metadata (see {@link #metadataChanged()}).
	 * E.g., if the user moves
	 ...
	 * by the model needs to be saved; <code>false</code> otherwise
	 */
