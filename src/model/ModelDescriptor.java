...
/**
 * A descriptor for a DES model. A plugin wishing to implement a new DES model
 * should implment this interface and the register it with the
 * {@link ModelManager}.
 * 
...
{
	/**
	 * Returns all the DES model interfaces this model implements. For example,
	 * if it implements an FSA, it should return {@link FSAModel}. Custom
	 ...
	 * 
	 * @param id
	 *            the ID which will be used to identify the model instance.
	 *            Preferrably a unique string ({@link General#getRandomId()}
	 *            can be used).
	...
	// * Preferrably a unique string ({@link General#getRandomId()} can be
	// used).
