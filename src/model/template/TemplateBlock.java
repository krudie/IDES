...
public interface TemplateBlock extends DESElement, Annotable {
	...
	/**
	 * Returns the set of interface events, which can
	 * be linked to other events.
	 ...
	 * @param events the new set of interface events
	 ...
	 * @param e the interface event to use for look-up
