...
public class TemplateMessage {
	...
	public TemplateMessage(int eventType, int elementType, long elementId, TemplatePublisher source) {
		this(eventType, elementType, elementId, source, "");
	}	

	public TemplateMessage(int eventType, int elementType, long elementId, TemplatePublisher source, String messageText) {
		super();		
